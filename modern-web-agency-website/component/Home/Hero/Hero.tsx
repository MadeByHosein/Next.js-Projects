...
const Hero = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden ">
        ...
        <div className="relativ z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div>
            ...
            {/* description */}
            <p className="text-base sm:text-lg text-gray-200 mb-12 max-w-3xl mx-auto leading-relaxed ">
        ...
        <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce ">
          <div className="w-6 h-10 p-2 border-2 border-white rounded-full flex justify-center items-center">
